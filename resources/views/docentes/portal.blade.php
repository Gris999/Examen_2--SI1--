...
<div class="row">
  <div class="col-12">
      ...
      <div class="card-body">
        <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-2">
          ...
          <div class="d-flex align-items-center gap-2">
            ...
            <a href="{{ route('docente.portal.export') }}" class="btn btn-outline-primary btn-sm">Exportar en Excel</a>
          </div>
        </div>
    ...
    <div class="card shadow-sm mb-3" id="registro">
      <div class="card-body">
